...
describe("Validating Government Identification", () => {
  ...
  it('Validating the cancel icon', ()=>{
    ...
    cy.get('a.arrow--close--nav').click()

    //Verify that the user is redirected to the personal info

    cy.url().should('equ', 'https://staging.brooi.com/account-settings/personal-info')
  ...
  it('Validate the back button', ()=>{
     ...
     cy.get('span.back--button--wrapp').should('be.visible')
     cy.get('span.back--button--wrapp').click()

     //verify that the url chnages to  choose-id-type

     cy.url().should('equ', 'https://staging.brooi.com/account-settings/personal-info/government-id/choose-id-type')
     cy.get('span.back--button--wrapp').should('be.visible')
     cy.get('span.back--button--wrapp').click()

     //verify tht the url changes to provide-id
     cy.url().should('equ', 'https://staging.brooi.com/account-settings/personal-info/government-id/provide-id')
     cy.get('span.back--button--wrapp').should('be.visible')
     cy.get('span.back--button--wrapp').click()

     //verify that the user is rediected to personal info 
     cy.url().should('equ', 'https://staging.brooi.com/account-settings/personal-info')
     cy.get('span.back--button--wrapp').should('not.be.visible')
