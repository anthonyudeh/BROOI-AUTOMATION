describe('Become a host', () => {
    ...
    it('postive test', () => {
        ...
        // cy.url().should('equal', 'https://staging.brooi.com/become-a-host').and('include', 'staging.brooi.com/become-a-host')

        //assertion
        cy.get("h3.blank-txt-wrapper").should('equal','Welcome back, David')
